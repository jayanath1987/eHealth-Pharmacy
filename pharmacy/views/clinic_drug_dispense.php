					...
					/*
						...
						*/
						echo '<tr>';
							...
							echo '</td>';						
							echo '<td>';
								if (isset($clinic_prescription_info["PrescribeBy"])){
									echo 'Doctor : <b>'.$clinic_prescription_info["PrescribeBy"].'</b>';
								}
							echo '</td>';
							echo '<td>';							
						...
						echo '</tr>';
                                                echo '<tr>';
							echo '<td>';
								if ($clinic_prescription_info["Status"]=='Dispensed'){
									echo 'Dispensed By : <b>'.$clinic_prescription_info["LastUpDateUser"].'</b>';
								}
							echo '</td>';
					echo '</table><br>';	
                                ...
                                $d_count = ceil($d * $cnt * $n);
									...
									/*if ($prescribe_items_list[$i]["Status"] =="Pending"){
										...
										echo $prescribe_items_list[$i]["Quantity"];
                                                           ...
                                                           if (($clinic_prescription_info["Status"] =="Pending") || ($clinic_prescription_info["Status"] == "Serving")) {

                                //echo $n.'-'.$cnt.'-'.$d;
                               echo '<input id="'.$prescribe_items_list[$i]["clinic_prescribe_item_id"].'" name="'.$prescribe_items_list[$i]["clinic_prescribe_item_id"].'" type="number" min=0 step=1 max=500 value="'.$d_count.'">';		
			       echo '<input id="_'.$prescribe_items_list[$i]["clinic_prescribe_item_id"].'" name="_'.$prescribe_items_list[$i]["clinic_prescribe_item_id"].'" type="hidden" value="'.$prescribe_items_list[$i]["DRGID"].'">';
						...
						echo '</table>';
                            ...
                            echo "<input onclick=\"printPrescription('" . site_url("report/pdf/ClinicoutsidePrescription/print/") . "')\" value='Print' type='button' class='btn btn-default'/>&nbsp;&nbsp;";
